...
class NotebookTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.classLabel.text = assignmentList[indexPath.row].className
        cell.assignmentLabel.text = assignmentList[indexPath.row].assignmentName
        cell.dueLabel.text =  assignmentList[indexPath.row].dueDay
