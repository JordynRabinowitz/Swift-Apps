...
class ViewController: UIViewController {
    ...
    @IBOutlet weak var opponentCardImageView: UIImageView!
 ...
 //0-51
    ...
    override func viewDidLoad() {
        ...
        warButton.layer.cornerRadius = 8.0
    }
    
    @IBAction func warButtonTapped(_ sender: UIButton) {
        ...
        winner = determineWinner(playerCard: playerCard, opponentCard: opponentCard)
        
        //TODO: Display winner with delay
        DispatchQueue.main.asyncAfter(deadline: .now() + 1.0) {
            let alert = UIAlertController(title: "\(self.winner) wins!", message: "Play again!", preferredStyle: .alert)
